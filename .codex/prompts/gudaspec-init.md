...
4. **Validate MCP Tools Availability**
   - For each unavailable tool, display a clear warning message with installation instructions:
     - **Gemini MCP**: "The `gemini` tool is not available. Please install it from: https://github.com/missdeer/gemini-mcp-rs.git"
...
- `gemini` installation: https://github.com/missdeer/gemini-mcp-rs.git
