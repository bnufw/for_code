...
Use template from `/home/zhu/workflow/for_code/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/zhu/workflow/for_code/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/zhu/workflow/for_code/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
