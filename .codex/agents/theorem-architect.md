...
<output>
## THEORY_HOOK
Write the final `#### Theory hook` block for `.codex/active_idea.md` with exactly these two theorem groups in order:
- `##### Theorem 1: <short name>`
- `##### Theorem 2: <short name>`

Inside each theorem group, provide exactly these fields in order:
- `Assumptions`
- `Claim`
- `Why non-trivial`
- `Proof sketch`
