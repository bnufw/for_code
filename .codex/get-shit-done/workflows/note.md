...
- **Global scope**: `/home/zhu/workflow/for_code/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/zhu/workflow/for_code/.codex/notes/`)
...
2. Glob `/home/zhu/workflow/for_code/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/zhu/workflow/for_code/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/zhu/workflow/for_code/.codex/notes/` — works in any directory
